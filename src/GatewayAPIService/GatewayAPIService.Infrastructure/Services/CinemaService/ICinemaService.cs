...
namespace GatewayAPIService.Infrastructure.Services.CinemaService
{
    ...
    {
        void Authorize(string scheme, string? value);
        ...
        Task<Page<CinemasResponse>?> GetByIds(string[] ids, CancellationToken ct, SortBy? pg = null);
        Task<IEnumerable<SearchResponse>?> GetBySearch(string search, CancellationToken ct, Pagination? pg = null);
        Task<Page<CinemasResponse>?> GetBySearchPage(string search, CancellationToken ct, Pagination? pg = null);
        Task<Page<CinemasResponse>?> GetByYear(int year, CancellationToken ct, SortBy? st = null, Pagination? pg = null);
        Task<Page<CinemasResponse>?> GetByYearSpans(int[] yearsLower, int yearSpan, CancellationToken ct, SortBy? st = null, Pagination? pg = null);
        ...
        Task<CinemaResponse?> UpdateMain(string id, UpdateCinemaRequest cinema, CancellationToken ct);
